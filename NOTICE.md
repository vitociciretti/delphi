...
**SimulatedWorld** is a derivative work based on **MiroFish**
...
(AGPL-3.0). SimulatedWorld preserves that license — see [`LICENSE`](./LICENSE) —
...
SimulatedWorld tracks the MiroFish codebase and adds improvements aimed at
